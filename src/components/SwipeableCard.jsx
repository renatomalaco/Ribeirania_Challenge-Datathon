...
export const SwipeableCard = ({ cardData, onSwipe, onReset }) => {
  ...
  const leftTextOpacity = useTransform(x, [0, swipeThreshold * 0.8], [0, 1]);
  const rightTextOpacity = useTransform(x, [0, -swipeThreshold * 0.8], [0, 1]);
